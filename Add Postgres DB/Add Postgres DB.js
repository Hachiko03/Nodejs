...
var db = pgPromise()("postgres://postgres:postgres@localhost:5432/Develhope");
/* console.log(db) */
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                name = req.body.name;
                return [4 /*yield*/, db.none("INSERT INTO planets (name) VALUES ($1)", name)];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                name = req.body.name;
                return [4 /*yield*/, db.none("UPDATE planets SET name=$2 WHERE is=$1", [Number(id), name])];
            case 1:
                _a.sent();
...
var deleteById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, db.none("DELETE FROM planets WHERE id=$1", Number(id))];
            case 1:
                _a.sent();
